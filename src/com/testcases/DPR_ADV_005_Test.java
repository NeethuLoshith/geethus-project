...
public class DPR_ADV_005_Test {
	...
	public void DPR_ADV_005() throws InterruptedException {
		...
		//Verify Agency Contacts table displays Name, Address, Email, Telephone, Role
		...
		//Verify Languages table displays Name
		Assert.assertEquals(Keywords.get_text(DPR_ADV_005_Elements.Language_Name),DPR_ADV_005_Data.Expected_LANGUAGES);
		
		
		//Verify Technical cost shows the list of creative sizes and corresponding costs
		...
		//Verify Cost table displays Small, Medium, Large and corresponding values.		
		...
		//Verify other table displays vat, co brand, Currency, Brand, agency fee and adserver sytem		
		...
		//Verify the Placement naming field		
